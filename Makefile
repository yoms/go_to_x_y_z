...
SOURCES = \
	__init__.py \
	go_to_xyz.py go_to_xyz_dialog.py

PLUGINNAME = go_to_xyz

PY_FILES = \
	__init__.py \
	go_to_xyz.py go_to_xyz_dialog.py

UI_FILES = go_to_xyz_dialog_base.ui
...
QGISDIR=/home/ghormiere/.local/share/QGIS/QGIS3/profiles/default/python/plugins/
